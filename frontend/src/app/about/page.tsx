  ...
  const aboutFAQ = [
    {
      ...
      answer: "4 yılı aşkın süredir profesyonel olarak backend (PHP, Laravel, NestJS, BullMQ, SQS) ve mobil (Expo, React Native) yazılım alanında çalışmaktayım."
    },
    {
      question: "Hangi dilleri ve teknolojileri aktif kullanıyorsunuz?",
      answer: "PHP, Laravel, JavaScript, TypeScript, NestJS, Next.js, React Native, Expo, MySQL, PostgreSQL, BullMQ, SQS ve Redis."
    },
    {
