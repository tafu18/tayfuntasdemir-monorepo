...
export default function Applications() {
  const apps = [
    // ARAÇLAR
    { name: 'PusulaAPI', desc: 'Gelişmiş API test aracı.', path: '/pusula-api', icon: '🧭', color: 'text-blue-500 hover:shadow-blue-500/20' },
    ...
    { name: 'Sözlük', desc: 'Kelime anlamlarını keşfedin.', path: '/sozluk', icon: '📖', color: 'text-indigo-500 hover:shadow-indigo-500/20' },
    { name: 'IP Adresim', desc: 'Dış IP adresinizi anında öğrenin.', path: '/tools/ip', icon: '🔌', color: 'text-blue-500 hover:shadow-blue-500/20' },
    { name: 'Epoch Converter', desc: 'Zaman damgası dönüştürücü.', path: '/tools/epoch', icon: '⏰', color: 'text-indigo-500 hover:shadow-indigo-500/20' },
    ...
    { name: 'Regex Tester', desc: 'Düzenli ifadeleri test edin ve renklendirin.', path: '/tools/regex', icon: '🔍', color: 'text-indigo-500 hover:shadow-indigo-500/20' },
    ...
    { name: 'URL Codec', desc: 'URL kodlama ve çözme aracı.', path: '/tools/url', icon: '🔗', color: 'text-blue-500 hover:shadow-blue-500/20' },
