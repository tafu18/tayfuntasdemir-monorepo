...
export default function Applications() {
  const apps = [
    ...
    { name: 'IP Adresim', desc: 'Dış IP adresinizi anında öğrenin.', path: '/ip', icon: '🔌', color: 'text-brand-blue hover:shadow-blue-500/20' },
    { name: 'Epoch Converter', desc: 'Zaman damgası dönüştürücü.', path: '/epoch', icon: '⏰', color: 'text-brand-blue hover:shadow-blue-500/20' },
    { name: 'JSON Formatter', desc: 'JSON verilerini güzelleştirin.', path: '/json', icon: '💻', color: 'text-purple-500 hover:shadow-purple-500/20' },
    { name: 'Base64 Atölyesi', desc: 'Base64 kodlama ve çözme.', path: '/base64', icon: '🛡️', color: 'text-amber-500 hover:shadow-amber-500/20' },
    { name: 'Hicri Dönüştürücü', desc: 'Hicri ve Miladi takvim dönüşümü.', path: '/hicri', icon: '🌙', color: 'text-green-500 hover:shadow-green-500/20' },
    { name: 'İnteraktif Terminal', desc: 'Web sitesini komut satırından deneyimleyin.', path: '/terminal', icon: '📟', color: 'text-gray-500 hover:shadow-gray-500/20' },
    { name: 'Regex Tester', desc: 'Düzenli ifadeleri test edin ve renklendirin.', path: '/regex', icon: '🔍', color: 'text-brand-blue hover:shadow-blue-500/20' },
    { name: 'JWT Decoder', desc: 'JSON Web Token (JWT) kodlarını çözün.', path: '/jwt', icon: '🔑', color: 'text-purple-500 hover:shadow-purple-500/20' },
    { name: 'JWT Secret Üretici', desc: 'Kriptografik güvenli JWT Secret Key ve Token üretici.', path: '/jwt-secret-generator', icon: '🛡️', color: 'text-emerald-500 hover:shadow-emerald-500/20' },
    { name: 'Cron Generator', desc: 'Crontab üretici, Türkçe açıklayıcı ve zamanlayıcı.', path: '/cron-generator', icon: '⏰', color: 'text-cyan-500 hover:shadow-cyan-500/20' },
    { name: 'cURL Dönüştürücü', desc: 'cURL komutlarını Fetch, Axios, Python kodlarına dönüştürün.', path: '/curl-converter', icon: '🌐', color: 'text-indigo-500 hover:shadow-indigo-500/20' },
    { name: 'URL Codec', desc: 'URL kodlama ve çözme aracı.', path: '/url', icon: '🔗', color: 'text-brand-blue hover:shadow-blue-500/20' },
    { name: 'Code Diff Slider', desc: 'Kod karşılaştırma sürgüsü.', path: '/code-diff', icon: '📊', color: 'text-amber-500 hover:shadow-amber-500/20' },
