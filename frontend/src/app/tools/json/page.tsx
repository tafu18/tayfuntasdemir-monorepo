      ...
      <div className="max-w-6xl mx-auto px-4 py-16 sm:px-6 lg:px-8 space-y-8">
        <header className="text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black mt-4 tracking-tight text-zinc-900 dark:text-white">
            JSON <span className="bg-gradient-to-r from-purple-600 to-brand-dark bg-clip-text text-transparent">Formatter</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                <Code className="h-5 w-5 text-brand-blue" /> Çıkış JSON
              </h2>
              {outputJson && (
                <button
