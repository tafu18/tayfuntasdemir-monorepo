      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 space-y-8">
        <header className="text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black mt-4 tracking-tight text-zinc-900 dark:text-white">
            Base64 <span className="bg-gradient-to-r from-brand-blue to-sky-655 bg-clip-text text-transparent">Atölyesi</span>
          </h1>
        ...
        <div className="flex border-b border-zinc-200 dark:border-zinc-800">
          <button
            ...
            className={`flex-1 py-3 text-sm font-bold border-b-2 transition-all ${
              tab === 'text'
                ? 'border-brand-blue text-brand-dark dark:text-brand-blue'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <button
                  onClick={encodeText}
                  className="flex-1 bg-brand-dark hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl transition-all"
                >
                  Base64 Encode
                </button>
                <button
            ...
            <div className="space-y-6">
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4">
                <h3 className="font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                  <FileUp className="h-5 w-5 text-brand-blue" /> Dosya → Base64
                </h3>
                ...
                <input
                  type="file"
                  onChange={encodeFile}
                  className="w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-650 hover:file:bg-blue-100 dark:file:bg-blue-950/30 dark:file:text-brand-blue"
                />
              </div>

              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4">
                <h3 className="font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                  <FileText className="h-5 w-5 text-brand-blue" /> Base64 → Dosya
                </h3>
                <textarea
                  value={fileInputText}
        ...
        {/* Global Toast */}
        {toastMessage && (
          <div className="fixed bottom-4 right-4 bg-brand-dark text-white px-4 py-3 rounded-xl shadow-lg flex items-center gap-2 z-50">
