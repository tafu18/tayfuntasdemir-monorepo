...
import { Shield, Check, Copy, Trash } from 'lucide-react';
...
export default function Base64Converter() {
  ...
  const encodeText = () => {
    ...
    try {
      ...
      setError('Kodlama işlemi başarısız oldu.');
    }
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 sm:px-6 lg:px-8 space-y-8">
        <header className="text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black mt-4 tracking-tight text-zinc-900 dark:text-white">
            Base64 <span className="bg-gradient-to-r from-amber-600 to-orange-650 bg-clip-text text-transparent">Atölyesi</span>
          </h1>
          <p className="mt-4 text-zinc-500 dark:text-zinc-400">
            Metinlerinizi Base64 formatına dönüştürün veya Base64 verilerinizi çözün.
          </p>
        </header>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                <Shield className="h-5 w-5 text-amber-500" /> Giriş Metni
              </h2>
              <button
                onClick={clearAll}
